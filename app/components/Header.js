      ...
      <section className="flex justify-between items-center p-2  border  border-y-1 border-[#dddfe2] ">
        <div className="flex ml-2 rounded-full items-center  gap-2">
          ...
          <div className="flex p-3 rounded-full bg-gray-100">
            ...
            <input
              className="flex ml-2 bg-transparent"
              type="text"
        ...
        <div className="flex gap-4">
          ...
          <div className="rounded-full p-5  bg-gray-100">
            ...
            >
              <path
                fill-rule="evenodd"
                d="m10.957 12.413-2.601-2.66-5.012 2.727 5.494-5.737 2.602 2.66 5.012-2.727-5.495 5.737zM9.897 0C4.341 0 0 4.144 0 9.257c0 2.908.853 5.503 3.902 7.2V20l3.27-1.874c.915.252 1.804.387 2.808.387 5.556 0 10.02-4.144 10.02-9.256C20 4.144 15.455 0 9.897 0z"
              ></path>
            </svg>
          </div>
